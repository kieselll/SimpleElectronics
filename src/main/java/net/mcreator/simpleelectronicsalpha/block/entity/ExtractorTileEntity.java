...
public class ExtractorTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public ExtractorTileEntity(BlockPos pos, BlockState state) {
		super(SimpleElectronicsAlphaModBlockEntities.EXTRACTOR.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<ExtractorTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<ExtractorTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
