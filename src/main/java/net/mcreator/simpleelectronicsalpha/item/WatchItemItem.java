...
import net.mcreator.simpleelectronicsalpha.procedures.WatchItemItemInInventoryTickProcedure;
import net.mcreator.simpleelectronicsalpha.procedures.WatchItemBeingProcedure;
import net.mcreator.simpleelectronicsalpha.item.inventory.WatchItemInventoryCapability;
...
public class WatchItemItem extends Item {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openGui(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return new TextComponent("Watch");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new WatchMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		WatchItemBeingProcedure.execute(itemstack);
	}
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new WatchItemInventoryCapability();
	}
